...
<script src="${assets}/global/plugins/echarts-2.2.7/build/dist/echarts.js"></script>

<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS<script src="${ctxStatic}/jquery/jquery.md5.js" type="text/javascript"></script> -->
<script src="${assets}/js/dialoglinks.js" type="text/javascript"></script>
<script src="${ctxStatic}/common/albedo.js" type="text/javascript"></script>

<script src="${ctxStatic}/common/albedo.form.component.js" type="text/javascript"></script>
